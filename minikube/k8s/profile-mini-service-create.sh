...
export K8_PROFILE_NAME=mini-service
export K8_NAMESPACE=mini-service
export K8_MINIK_RAM_MB=6GB
export K8_MINIK_CPU_NUM=4
export K8_MINIK_DISK=25GB
export K8_LOG_LEVEL=1
export K8_API_VERSION=v1.19.2
export K8_MINIKUBE_DRIVER=hyperkit #hyperkit docker virtualbox
